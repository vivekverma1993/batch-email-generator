...
def setup_database(drop_existing: bool = False, test_connection: bool = True) -> bool:
    ...
    Returns:
        bool: Success status
    """
    print("🗄️  Email Generator Database Setup")
    print("=" * 50)
    ...
    try:
        ...
        print(f"⚠️  Warning: Could not record initial metrics: {e}")
        ...
        if success:
            ...
            with db_manager.session_scope() as session:
                ...
                if table_check:
                    ...
                    print("⚠️  No email generator tables found. Run --setup to create them.")
